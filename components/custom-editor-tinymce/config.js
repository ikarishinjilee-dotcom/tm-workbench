...
const config = {
  ...
  // 工具栏
  toolbar: [
    'bold italic underline strikethrough fontsize forecolor backcolor alignleft aligncenter alignright outdent indent blockquote undo redo removeformat',
    'subscript superscript hr bullist numlist image images media link table insertdatetime codesample code preview fullscreen',
  ],
  // 菜单栏
  ...
  font_size_formats: '12px 13px 14px 15px 16px 18px 20px 24px 36px 48px 96px',
  line_height_formats: '1 1.2 1.5 1.6 1.8 2 2.4 3',
  link_title: false,
  branding: false,
