  ...
  <div>
    ...
    <div class="vk-page-card">
      ...
      <div class="vk-page-card-toolbar">
        <div class="vk-page-card-title">全局缓存列表</div>
...
<script>
  ...
  export default {
      ...
      return {
        ...
        queryForm1: {
          ...
          columns: [
            ...
            { key: '_add_time', type: 'datetimerange', title: '添加时间', span: 4, mode: '[]' },
          ],
        },
        form1: {
          // 表单请求数据，此处可以设置默认值
    ...
    methods: {
      ...
      addBtn() {
        this.resetForm();
        this.form1.props.action = 'admin/system_uni/global-data/sys/add';
      ...
      // 显示修改页面
      updateBtn({ item }) {
        this.form1.props.action = 'admin/system_uni/global-data/sys/update';
